...
window.addEventListener("load", function () {
  ...
  window.CHATBOT_SVG = '<svg viewBox="-9 -9 41 41" style="background-color: rgb(222, 25, 44); width: 69px; height: 69px; border-radius: 10px; box-shadow: rgba(0, 0, 0, 0.25) 0px 5px 5px; fill: rgb(255, 255, 255);"><path d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2M9 11H7V9h2zm4 0h-2V9h2zm4 0h-2V9h2z"></path></svg>';
